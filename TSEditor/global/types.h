...
struct LARA_INFO
{
	...
	short burnCount;
	short weaponItem;
	short weaponBackItem;
	short flareFrame;
	short poisoned;
	short dpoisoned;
	uchar anxiety;
	uchar wet[15];
	ushort flareControlLeft : 1;
	ushort flareControlRight : 1;
	ushort look : 1;
	ushort burn : 1;
	ushort keepDucked : 1;
	ushort isMoving : 1;
	...
	long ropeCount;
	char skelebob;
	char pistolsTypeCarried;
	char uzisTypeCarried;
	char shotgunTypeCarried;
	char crossbowTypeCarried;
	char hkTypeCarried;
	char sixshooterTypeCarried;
	char lasersight;
	char silencer;
	char binoculars;
	char crowbar;
	...
	short numSmallMedipack;
	short numLargeMedipack;
	short numFlares;
	short numPistolsAmmo;
	short numUziAmmo;
	short numRevolverAmmo;
	short numShotgunAmmo1;
	short numShotgunAmmo2;
	short numHKAmmo1;
	short numCrossbowAmmo1;
	short numCrossbowAmmo2;
	char location;
